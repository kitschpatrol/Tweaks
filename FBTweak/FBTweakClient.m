...
void FBReadStreamEventHandler(CFReadStreamRef stream, CFStreamEventType eventType, void *info);
void FBWriteStreamEventHandler(CFWriteStreamRef stream, CFStreamEventType eventType, void *info);
...
- (BOOL)setupSocketStreams {
  ...
  CFOptionFlags registeredEvents =
      kCFStreamEventOpenCompleted | kCFStreamEventHasBytesAvailable | kCFStreamEventCanAcceptBytes | kCFStreamEventEndEncountered | kCFStreamEventErrorOccurred;

  CFStreamClientContext ctx = {0, (__bridge void *)(self), NULL, NULL, NULL};

  CFReadStreamSetClient(_readStream, registeredEvents, FBReadStreamEventHandler, &ctx);
  CFWriteStreamSetClient(_writeStream, registeredEvents, FBWriteStreamEventHandler, &ctx);
